	...
	return (
		<main className="w-full">
			<div className="w-full flex flex-col gap-y-5">
				...
				<div className="Breadcrumbs h-[21px] w-full justify-start items-start gap-2 inline-flex  text-neutral-900 text-opacity-70 md: text-text-xs font-normal font-sans mb-3">
				...
				<div className="flex md:flex-row flex-col justify-between items-center w-full gap-y-5">
					<form
						className="md:w-[40%] w-full "
						onSubmit={handleSubmit(submit)}>
						<Input
							className="py-4 px-2  bg-gray-300 placeholder-slate-400 placeholder:text-lg"
				...
				<div className="flex flex-col gap-5">
					...
					<div className="flex gap-5 md:w-[50%] w-full flex-wrap">
						<button className="py-2 px-4 flex border-2 border-primary  rounded-lg gap-5">
							<svg
								width="20"
								height="22"
								viewBox="0 0 20 22"
						...
						<div className="overflow-y-scroll h-[300px]  flex flex-col w-full text-base text-primary font-sans shadow: gap-5 shadow-inner pb-20">
							<div className="flex items-start justify-between flex-wrap text-lg font-medium w-full">
								...
								<p className="w-[80%]">
									...
									desktop or mobile device and
									locate &quot;Marketplace&quot; in
									the left-hand menu or at the top
									of the First step. Open Facebook
									on your desktop or mobile device
									and locate &quot;Marketplace&quot;
									in the left-hand menu or at the
									top of the{" "}
								</p>
							</div>
							<div className="flex items-start justify-between flex-wrap text-lg font-medium w-full">
